...
function App() {
  ...
  const [customTheme, setCustomTheme] = useState({
    ...
    neutralColor2: '#EDEAF0',
    neutralColor3: '#B2AEB7',
    neutralColor4: '#6C6D86'
  })

  const { primaryColor, secondaryColor, neutralColor1, neutralColor2, neutralColor3, neutralColor4 } = customTheme
  ...
  const neutralColor4TextRef = useRef()
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--neutral-4', neutralColor4);
  }, [customTheme])
            ...
            <div className='flex flex-col w-5/6 md:grid md:grid-cols-2'>
              ...
              <div className='flex flex-col mb-4 items-center'>
                ...
                <div className='flex flex-row'>
                  ...
                  <input type="text" maxLength={7} name='primaryColor' value={primaryColor} ref={primaryColorTextRef} onChange={() => handleThemeChange(primaryColorTextRef)} className='w-24 text-center text-slate-900 p-2 rounded outline-none uppercase' />
                </div>
              </div>
              {/* Secondary Color */}
              <div className='flex flex-col mb-4 items-center'>
                ...
                <div className='flex flex-row'>
                  ...
                  <input type="text" maxLength={7} name='secondaryColor' value={secondaryColor} ref={secondaryColorTextRef} onChange={() => handleThemeChange(secondaryColorTextRef)} className='w-24 text-center text-slate-900 p-2 rounded outline-none uppercase' />
                </div>
              </div>
              {/* Neutral Color 1 */}
              <div className='flex flex-col mb-4 items-center'>
                ...
                <div className='flex flex-row'>
                  ...
                  <input type="text" maxLength={7} name='neutralColor1' value={neutralColor1} ref={neutralColor1TextRef} onChange={() => handleThemeChange(neutralColor1TextRef)} className='w-24 text-center text-slate-900 p-2 rounded outline-none uppercase' />
                </div>
              </div>
              {/* Neutral Color 2 */}
              <div className='flex flex-col mb-4 items-center'>
                ...
                <div className='flex flex-row'>
                  ...
                  <input type="text" maxLength={7} name='neutralColor2' value={neutralColor2} ref={neutralColor2TextRef} onChange={() => handleThemeChange(neutralColor2TextRef)} className='w-24 text-center text-slate-900 p-2 rounded outline-none uppercase' />
                </div>
              </div>
              {/* Neutral Color 3 */}
              <div className='flex flex-col mb-4 items-center'>
                ...
                <div className='flex flex-row'>
                  ...
                  <input type="text" maxLength={7} name='neutralColor3' value={neutralColor3} ref={neutralColor3TextRef} onChange={() => handleThemeChange(neutralColor3TextRef)} className='w-24 text-center text-slate-900 p-2 rounded outline-none uppercase' />
                </div>
              </div>
              {/* Neutral Color 4 */}
              <div className='flex flex-col mb-4 items-center'>
                ...
                <div className='flex flex-row'>
                  ...
                  <input type="text" maxLength={7} name='neutralColor4' value={neutralColor4} ref={neutralColor4TextRef} onChange={() => handleThemeChange(neutralColor4TextRef)} className='w-24 text-center text-slate-900 p-2 rounded outline-none uppercase' />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='w-5/6 flex flex-col items-center justify-between rounded-lg bg-neutral-1 text-secondary'>
              ...
              <div className='flex flex-col justify-center items-center w-11/12 py-4'>
                ...
                <div className='w-full flex flex-col mb-2'>
                  ...
                  <input className="bg-neutral-1 border border-neutral-3 rounded p-2 text-secondary outline-none focus:duration-200 duration-200 focus:border-primary placeholder:text-neutral-3" placeholder='Placeholder' type="text" />
                  <small className='text-neutral-4 text-sm'>small message</small>
                </div>
                <div className='w-full flex flex-col mb-4'>
                  <label className='text-primary'>Label</label>
                  <input className="bg-neutral-2 border border-neutral-3 rounded p-2 text-neutral-3 focus:border-primary outline-none" disabled value='Disabled' type="text" />
                </div>
